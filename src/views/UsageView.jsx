  ...
  return (
    <div className="animate-fade">
      ...
      <div className="nav-tabs">
        ...
        <div style={{ flex: 1 }} />
        <div style={{ fontSize: "var(--text-sm)", color: "var(--text-muted)", alignSelf: "center" }}>
      ...
      {usageTab === "openai" && (
        <div className="animate-fade">
          ...
          <div style={{
            ...
            <span style={{ fontSize: "var(--text-xs)", color: "var(--text-muted)" }}>OpenAI Console:</span>
            <a href={OPENAI_USAGE_URL} target="_blank" rel="noopener noreferrer"
              style={{ fontSize: "var(--text-xs)", color: "#10a37f", textDecoration: "none", fontWeight: 600 }}>
              Usage Dashboard
            </a>
          ...
          {!hasOpenAIKey ? (
            <div className="panel" style={{ textAlign: "center", padding: "3rem" }}>
              ...
              <div style={{ fontSize: "var(--text-base)", fontWeight: 600, marginBottom: "0.35rem" }}>No OpenAI API key configured</div>
              <div style={{ fontSize: "var(--text-sm)", color: "var(--text-muted)", marginBottom: "0.75rem", lineHeight: 1.6 }}>
                The OpenAI Usage API requires an <strong>Admin key</strong> (<code style={{ fontSize: "var(--text-xs)", background: "var(--bg-input)", padding: "1px 4px", borderRadius: 3 }}>sk-admin-*</code>).
                <br />Standard project keys (<code style={{ fontSize: "var(--text-xs)", background: "var(--bg-input)", padding: "1px 4px", borderRadius: 3 }}>sk-proj-*</code>) don't have access to usage data.
              </div>
            ...
            <div className="panel" style={{ padding: "2rem" }}>
              <div style={{ display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                ...
                <div>
                  <div style={{ fontSize: "var(--text-base)", fontWeight: 600, marginBottom: "0.35rem" }}>Admin key required</div>
                  <div style={{ fontSize: "var(--text-sm)", color: "var(--text-muted)", lineHeight: 1.6, marginBottom: "0.75rem" }}>
                    Your current key starts with <code style={{ fontSize: "var(--text-xs)", background: "var(--bg-input)", padding: "1px 4px", borderRadius: 3 }}>{openaiKey.slice(0, 10)}...</code> — this is a standard project key.
                    <br />The Usage & Costs API only works with <strong>Admin keys</strong> (<code style={{ fontSize: "var(--text-xs)", background: "var(--bg-input)", padding: "1px 4px", borderRadius: 3 }}>sk-admin-*</code>).
                  </div>
                  <div style={{ fontSize: "var(--text-xs)", color: "var(--text-dim)", marginBottom: "1rem", lineHeight: 1.6 }}>
                    ...
                    3. Paste the <code style={{ fontSize: "var(--text-xs)", background: "var(--bg-input)", padding: "1px 4px", borderRadius: 3 }}>sk-admin-...</code> key in Settings
                  </div>
            ...
            <>
              ...
              {openaiError && (
                <div style={{
                  ...
                  fontSize: "var(--text-sm)", color: "var(--accent-red)", lineHeight: 1.5,
                }}>
              ...
              <div className="stats-grid">
                <div className="panel" style={{ textAlign: "center", padding: "1.25rem 1rem" }}>
                  ...
                  <div style={{ fontSize: "var(--text-xs)", color: "var(--text-muted)", marginTop: "0.2rem" }}>Total Spent</div>
                </div>
                <div className="panel" style={{ textAlign: "center", padding: "1.25rem 1rem" }}>
                  ...
                  <div style={{ fontSize: "var(--text-xs)", color: "var(--text-muted)", marginTop: "0.2rem" }}>Whisper Usage</div>
                </div>
                <div className="panel" style={{ textAlign: "center", padding: "1.25rem 1rem" }}>
                  ...
                  <div style={{ fontSize: "var(--text-xs)", color: "var(--text-muted)", marginTop: "0.2rem" }}>GPT-4o-mini Usage</div>
                </div>
                <div className="panel" style={{ textAlign: "center", padding: "1.25rem 1rem" }}>
                  ...
                  <div style={{ fontSize: "var(--text-xs)", color: "var(--text-muted)", marginTop: "0.2rem" }}>Daily Average</div>
                </div>
              </div>
                    ...
                    <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "var(--text-sm)" }}>
                      <thead>
                        <tr style={{ borderBottom: "1px solid var(--border-subtle)" }}>
                          <th style={{ textAlign: "left", padding: "0.5rem 0.6rem", color: "var(--text-dim)", fontWeight: 600, fontSize: "var(--text-xs)", letterSpacing: "0.08em", textTransform: "uppercase" }}>Model</th>
                          <th style={{ textAlign: "right", padding: "0.5rem 0.6rem", color: "var(--text-dim)", fontWeight: 600, fontSize: "var(--text-xs)", letterSpacing: "0.08em", textTransform: "uppercase" }}>Cost</th>
                          <th style={{ textAlign: "right", padding: "0.5rem 0.6rem", color: "var(--text-dim)", fontWeight: 600, fontSize: "var(--text-xs)", letterSpacing: "0.08em", textTransform: "uppercase" }}>% of Total</th>
                        </tr>
                      </thead>
                      <tbody>
                ...
                <div className="panel">
                    ...
                    {(() => {
                      ...
                      return openaiUsage.dailyBreakdown.map((day) => (
                        <div key={day.date} style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                          <span style={{ fontSize: "var(--text-xs)", fontFamily: "var(--font-mono)", color: "var(--text-dim)", minWidth: 72 }}>
                            {day.date}
                          </span>
                          ...
                          <span style={{ fontSize: "var(--text-xs)", fontFamily: "var(--font-mono)", color: "var(--accent-green)", minWidth: 58, textAlign: "right" }}>
                            ${day.total.toFixed(4)}
                          </span>
                        </div>
                      ));
                  ...
                  <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap", marginTop: "0.75rem", paddingTop: "0.6rem", borderTop: "1px solid var(--border-subtle)" }}>
                    {Object.keys(openaiUsage.modelTotals).map((model) => (
                      <div key={model} style={{ display: "flex", alignItems: "center", gap: "0.3rem", fontSize: "var(--text-xs)", color: "var(--text-muted)" }}>
              ...
              {!openaiUsage && !openaiLoading && !openaiError && (
                <div className="panel" style={{ textAlign: "center", padding: "3rem" }}>
                  ...
                  <div style={{ fontSize: "var(--text-sm)" }}>Click Fetch to load OpenAI usage data</div>
                </div>
              )}
              ...
              {openaiUsage && !openaiUsage.dailyBreakdown?.length && !openaiLoading && (
                <div className="panel" style={{ textAlign: "center", padding: "2rem" }}>
                  <div style={{ fontSize: "1.5rem", marginBottom: "0.4rem" }}>📭</div>
                  <div style={{ fontSize: "var(--text-sm)" }}>No usage data for this period</div>
                  <div style={{ fontSize: "var(--text-xs)", marginTop: "0.2rem", color: "var(--text-dim)" }}>Try adjusting the date range</div>
                </div>
              )}
            </>
          )}
      ...
      <div style={{ marginBottom: "1.5rem" }}>
        <div style={{ fontSize: "var(--text-lg)", fontWeight: 700, marginBottom: "0.25rem" }}>Credit balance</div>
        <div style={{ fontSize: "var(--text-sm)", color: "var(--text-muted)", marginBottom: "1.25rem", lineHeight: 1.5 }}>
        ...
        <div style={{ display: "flex", gap: "1.25rem", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 1, minWidth: 220, display: "flex", flexDirection: "column", justifyContent: "center", gap: "0.85rem" }}>
            <div>
              <div style={{ fontSize: "var(--text-xs)", color: "var(--text-dim)", marginBottom: "0.35rem" }}>
              ...
              <div style={{ display: "flex", gap: "0.5rem", alignItems: "center" }}>
                <div style={{ position: "relative", flex: 1, maxWidth: 200 }}>
                  <span style={{
                    ...
                    color: "var(--text-dim)", fontSize: "var(--text-base)", fontWeight: 600, pointerEvents: "none",
                  }}>$</span>
                  <input
                    className="settings-input"
                    ...
                    style={{
                      paddingLeft: "1.5rem", fontSize: "var(--text-base)",
                      borderColor: aiUsage.creditBalance == null ? "var(--accent-indigo)" : undefined,
                    }}
                  />
                </div>
                <a href="https://console.anthropic.com/settings/billing" target="_blank" rel="noopener noreferrer"
                  className="btn-back" style={{ fontSize: "var(--text-sm)", textDecoration: "none", padding: "0.5rem 1rem" }}>
                  Buy credits
                </a>
              </div>
            </div>
            ...
            <div style={{
              ...
              <span style={{ fontSize: "var(--text-base)" }}>{overBudget ? "🔴" : aiUsage.budgetUsd ? "🟢" : "⚪"}</span>
      ...
      <div className="stats-grid">
        <div className="panel" style={{ textAlign: "center", padding: "1.25rem 1rem" }}>
          ...
          <div style={{ fontSize: "var(--text-xs)", color: "var(--text-muted)", marginTop: "0.2rem" }}>Total Requests</div>
        </div>
        <div className="panel" style={{ textAlign: "center", padding: "1.25rem 1rem" }}>
          <div style={{ fontSize: "1.6rem", fontWeight: 800, color: "var(--accent-green)", fontFamily: "var(--font-mono)" }}>
            {(aiUsage.totalInputTokens + aiUsage.totalOutputTokens).toLocaleString()}
          </div>
          <div style={{ fontSize: "var(--text-xs)", color: "var(--text-muted)", marginTop: "0.2rem" }}>Total Tokens</div>
        </div>
        <div className="panel" style={{ textAlign: "center", padding: "1.25rem 1rem" }}>
        ...
        <div className="panel" style={{ textAlign: "center", padding: "1.25rem 1rem" }}>
          ...
          <div style={{ fontSize: "var(--text-xs)", color: "var(--text-muted)", marginTop: "0.2rem" }}>Avg Cost / Request</div>
        </div>
      </div>
      ...
      <div className="budget-grid">
        ...
        <div className="panel">
          ...
          <div style={{ display: "flex", gap: "0.5rem", marginBottom: "0.75rem" }}>
            <div style={{ position: "relative", flex: 1 }}>
              <span style={{
                ...
                color: "var(--text-dim)", fontSize: "var(--text-sm)", fontWeight: 600, pointerEvents: "none",
              }}>$</span>
              <input
                className="settings-input"
                ...
                style={{ paddingLeft: "1.4rem", fontSize: "var(--text-sm)" }}
              />
            </div>
            {aiUsage.totalRequests > 0 && (
              <button onClick={resetUsage} className="btn-back" style={{ fontSize: "var(--text-xs)", padding: "0.4rem 0.75rem" }}>
                Reset Stats
              </button>
            )}
          </div>
          {aiUsage.budgetUsd && (
            <>
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: "var(--text-xs)", color: "var(--text-muted)", marginBottom: "0.35rem" }}>
              ...
              <div style={{ fontSize: "var(--text-xs)", color: "var(--text-dim)", marginTop: "0.35rem", textAlign: "right" }}>
        ...
        <div className="panel">
          ...
          <div style={{ fontSize: "var(--text-sm)", color: "var(--text-muted)", lineHeight: 2 }}>
          ...
          <div style={{ marginTop: "0.5rem", fontSize: "var(--text-xs)", color: "var(--text-dim)" }}>
      ...
      <div className="panel">
        ...
        {aiUsage.history.length === 0 ? (
          <div style={{ textAlign: "center", padding: "2rem", color: "var(--text-dim)" }}>
            <div style={{ fontSize: "1.5rem", marginBottom: "0.4rem" }}>📭</div>
            <div style={{ fontSize: "var(--text-sm)" }}>No AI requests yet</div>
            <div style={{ fontSize: "var(--text-xs)", marginTop: "0.2rem" }}>Generate a ticket with AI to start tracking</div>
          </div>
        ) : (
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "var(--text-sm)" }}>
              <thead>
                <tr style={{ borderBottom: "1px solid var(--border-subtle)" }}>
                  <th style={{ textAlign: "left", padding: "0.5rem 0.6rem", color: "var(--text-dim)", fontWeight: 600, fontSize: "var(--text-xs)", letterSpacing: "0.08em", textTransform: "uppercase" }}>Time</th>
                  <th style={{ textAlign: "left", padding: "0.5rem 0.6rem", color: "var(--text-dim)", fontWeight: 600, fontSize: "var(--text-xs)", letterSpacing: "0.08em", textTransform: "uppercase" }}>Agent</th>
                  <th style={{ textAlign: "right", padding: "0.5rem 0.6rem", color: "var(--text-dim)", fontWeight: 600, fontSize: "var(--text-xs)", letterSpacing: "0.08em", textTransform: "uppercase" }}>In</th>
                  <th style={{ textAlign: "right", padding: "0.5rem 0.6rem", color: "var(--text-dim)", fontWeight: 600, fontSize: "var(--text-xs)", letterSpacing: "0.08em", textTransform: "uppercase" }}>Out</th>
                  <th style={{ textAlign: "right", padding: "0.5rem 0.6rem", color: "var(--text-dim)", fontWeight: 600, fontSize: "var(--text-xs)", letterSpacing: "0.08em", textTransform: "uppercase" }}>Cost</th>
                </tr>
              </thead>
              <tbody>
                {aiUsage.history.map((h, i) => {
                  ...
                  return (
                    <tr key={i} style={{ borderBottom: "1px solid var(--border-subtle)" }}>
                      <td style={{ padding: "0.5rem 0.6rem", color: "var(--text-dim)", fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)" }}>
